...
import { getEncounters } from '../services/fhir-repository'
import { patientQuerySchema } from '../schemas/common'
import { BadRequestError } from '../utils/errors'
import { normalizePatientReference } from '../utils/fhir'
import type { AppEnv } from '../types'

export const listEncountersHandler = async (c: Context<AppEnv>) => {
  ...
  const payload = await getEncounters(patientId)
